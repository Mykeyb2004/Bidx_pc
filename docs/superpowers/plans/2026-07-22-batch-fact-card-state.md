...
- [x] **Step 1: Write failing aggregate-state tests**
...
- [x] **Step 3: Implement pure summary models and logic**
...
- [x] **Step 4: Run aggregate tests and verify GREEN**

Run: `uv run pytest tests/test_fact_cards.py -k 'batch_chapter_fact_card' -v`

Expected: PASS.

- [x] **Step 5: Write failing atomic-patch tests**
...
- [x] **Step 6: Run patch tests and verify RED**
...
- [x] **Step 7: Implement atomic patch and BidWriter facade**
...
- [x] **Step 8: Run store tests and verify GREEN**
...
- [x] **Step 1: Write failing pure-dialog-state tests**
...
- [x] **Step 2: Run dialog-state tests and verify RED**
...
- [x] **Step 3: Implement immutable dialog result and pure helpers**
...
- [x] **Step 4: Run pure-dialog tests and verify GREEN**

Run: `uv run pytest tests/test_fact_card_dialogs.py -k 'batch_fact_card' -v`

Expected: PASS for helper tests.

- [x] **Step 5: Write failing window behavior tests**
...
- [x] **Step 6: Run window tests and verify RED**
...
- [x] **Step 7: Implement the independent configuration window**
...
- [x] **Step 8: Run dialog tests and verify GREEN**
...
- [x] **Step 1: Write failing batch integration tests**
...
- [x] **Step 3: Implement batch summary/editor branch**
...
- [x] **Step 4: Preserve the result tuple contract**
