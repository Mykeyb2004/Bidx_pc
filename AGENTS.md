...
This project is indexed by GitNexus as **Bidx_pc** (5726 symbols, 11460 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
